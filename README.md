...
As ETAPAS 1 — lógica e integridade — e 2 — limpeza técnica e organização de código — estão concluídas/validadas. O backend mantém checkpoint de **111 testes verdes** com MySQL/Flyway V12 validado. A ETAPA 3 é a próxima do roadmap.
