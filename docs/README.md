...
No estado atual, as **ETAPAS 0–3 estão encerradas/validadas**. A **ETAPA 4 — Consolidação funcional e polimento do MVP** está em andamento; os **BLOCOS 1 e 2 estão concluídos/validados** e o **BLOCO 3 — Operação competitiva** está em andamento, iniciando pela **3A — Follow Line**.
